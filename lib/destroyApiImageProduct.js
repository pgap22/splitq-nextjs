...
export async function destroyApiImageProduct(public_id, url) {
    try {
        ...
        const res = await fetch(`https://api.cloudinary.com/v1_1/${process.env.CLOUDINARY_NAME}/image/destroy`, {
            method: 'POST',
            body: formData
        })
