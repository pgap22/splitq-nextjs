...
import { MdFastfood, MdIcecream, MdLandscape, MdOutlineFastfood, MdOutlineLandscape, MdOutlineLocalCafe, MdOutlineLocalOffer, MdOutlineLunchDining, MdOutlineSportsBar, MdOutlineStore, MdOutlineVerifiedUser } from "react-icons/md";
        ...
        <>
            ...
            <div className="mt-4">
                ...
                <div className="flex-col gap-4">
                    {
                        sellers.map(item => <SellerCard seller={item} />)
                    }
                </div>
            </div>
        </>
